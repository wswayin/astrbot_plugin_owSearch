...
@dataclass(frozen=True)
class DashenQuickStrengthMatchPoint:
    match_id: str
    begin_ts: int
    result: int
    map_guid: str
...
@dataclass(frozen=True)
class DashenQuickStrengthOutput:
    customer_token: str
    full_id: str
    bnet_id: str
    summary: DashenQuickStrengthSummary
...
class DashenQuickStrengthModule:
    def __init__(
        ...
        self.engine = DashenQuickStrengthEngine(self.requests)
    ...
    async def query_quick_strength(
        ...
        *,
        ...
        return DashenQuickStrengthOutput(
            customer_token=query.customer_token,
            full_id=full_id,
            bnet_id=bnet_id,
            summary=summary,
    ...
    def _load_ow_config(self) -> Dict[str, Any]:
        try:
            ...
            print(f"[overstats] failed to load query_tool config for quick strength: {exc}")
            return {}


dashen_quick_strength_module = DashenQuickStrengthModule()
